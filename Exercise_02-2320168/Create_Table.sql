CREATE TABLE `vehicle_collision` (
  ...
  `BOROUGH` varchar(8) DEFAULT NULL,
  ...
  `CONTRIBUTNG_FACTOR_VEHICLE_1` varchar(45) DEFAULT NULL,
  `CONTRIBUTNG_FACTOR_VEHICLE_2` varchar(45) DEFAULT NULL,
  `CONTRIBUTNG_FACTOR_VEHICLE_3` varchar(45) DEFAULT NULL,
  `CONTRIBUTNG_FACTOR_VEHICLE_4` varchar(45) DEFAULT NULL,
  `CONTRIBUTNG_FACTOR_VEHICLE_5` varchar(45) DEFAULT NULL,
