CREATE TABLE `vehicle_collision` (
  ...
  `CONTRIBUTING_FACTOR _VEHICLE_1` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR _VEHICLE_2` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR _VEHICLE_3` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR _VEHICLE_4` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR _VEHICLE_5` varchar(45) DEFAULT NULL,
  `COLLISION_ID` varchar(45) DEFAULT NULL,
  `VEHICLE TYPE CODE 1` varchar(45) DEFAULT NULL,
