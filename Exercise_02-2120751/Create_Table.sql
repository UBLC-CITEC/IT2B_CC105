CREATE TABLE `vehicle_collision` (
  ...
  `CONTRIBUTING_FACTOR_1` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR_2` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR_3` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR_4` varchar(45) DEFAULT NULL,
  `CONTRIBUTING_FACTOR_5` varchar(45) DEFAULT NULL,
